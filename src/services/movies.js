...
class MovieDataService {
    ...
    getAll(page = 0) {
        return axios.get(`https://movie-review-blog-frontend.netlify.app/api/v1/movies?page=${page}`);
        // return axios.get(`http://localhost:5000/api/v1/movies?page=${page}`);
    }

    // gets the specific movie with the supplied id
    get(id) {
        return axios.get(`https://movie-review-blog-frontend.netlify.app/api/v1/movies/id/${id}`);
    ...
    find(query, by = 'title', page = 0) {
        return axios.get(`https://movie-review-blog-frontend.netlify.app/api/v1/movies?${by}=${query}&page=${page}`);
        // return axios.get(`http://localhost:5000/api/v1/movies?${by}=${query}&page=${page}`);
    }

    createReview(data) {
        return axios.post("https://movie-review-blog-frontend.netlify.app/api/v1/movies/review", data);
        // return axios.post("http://localhost:5000/api/v1/movies/review", data);
    }

    updateReview(data) {
        return axios.put("https://movie-review-blog-frontend.netlify.app/api/v1/movies/review", data);
        // return axios.put("http://localhost:5000/api/v1/movies/review", data);
    }

    deleteReview(id, userId) {
        return axios.delete(
            "https://movie-review-blog-frontend.netlify.app/api/v1/movies/review",
    ...
    getRatings() {
        return axios.get("https://movie-review-blog-frontend.netlify.app/api/v1/movies/ratings")
